...
var SCRIPT_ID = 'tradingview-market-widget-script';
var CONTAINER_ID = 'tradingview-market-widget';
var TradingViewMarketWidget = /*#__PURE__*/function (_PureComponent) {
  _inheritsLoose(TradingViewMarketWidget, _PureComponent);
  ...
  function TradingViewMarketWidget() {
    ...
    _this.containerId = CONTAINER_ID + "-" + Math.random();
    ...
    _this.appendScript = function (onload) {
      ...
      script.innerHTML = JSON.stringify(_extends({}, TradingViewMarketWidget.defaultProps, _this.props));
  ...
  return TradingViewMarketWidget;
}(React.PureComponent);
TradingViewMarketWidget.propTypes = {
  colorTheme: propTypes.oneOf([Themes.LIGHT, Themes.DARK]),
  dateRange: propTypes.oneOf(['1d', '5d', '1m', '3m', '6m', RangeTypes.YTD, '12m', '60m', RangeTypes.ALL]),
...
var SCRIPT_ID$1 = 'tradingview-stock-chart-widget-script';
var CONTAINER_ID$1 = 'tradingview-stock-chart-widget';
var TradingViewStockChartWidget = /*#__PURE__*/function (_PureComponent) {
  _inheritsLoose(TradingViewStockChartWidget, _PureComponent);
  ...
  function TradingViewStockChartWidget() {
    ...
    _this = _PureComponent.call.apply(_PureComponent, [this].concat(args)) || this;
    _this.containerId = CONTAINER_ID$1 + "-" + Math.random();
    ...
    _this.initWidget = function () {
      ...
      var _this$props = _this.props,
          ...
          widgetConfig = _objectWithoutPropertiesLoose(_this$props, ["widgetType"]);

      var config = _extends({}, widgetConfig, {
...
TradingViewStockChartWidget.propTypes = {
  ...
  range: propTypes.oneOf(['1d', '5d', '1m', '3m', '6m', RangeTypes.YTD, '12m', '60m', RangeTypes.ALL]),
  ...
  style: propTypes.oneOf([BarStyles.BARS, BarStyles.CANDLES, BarStyles.HOLLOW_CANDLES, BarStyles.HEIKIN_ASHI, BarStyles.LINE, BarStyles.AREA, BarStyles.RENKO, BarStyles.LINE_BREAK, BarStyles.KAGI, BarStyles.POINT_AND_FIGURE]),
...
exports.BarStyles = BarStyles;
exports.IntervalTypes = IntervalTypes;
exports.RangeTypes = RangeTypes;
exports.Themes = Themes;
exports.TradingViewMarketWidget = TradingViewMarketWidget;
exports.TradingViewStockChartWidget = TradingViewStockChartWidget;
